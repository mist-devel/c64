...
(
	...
	.F0(F0),
	.Res_Filt(filter_en[n] ? Filter_Res_Filt[n] : 8'h00),
	.Mode_Vol(Filter_Mode_Vol[n]),
	.voice1(voice_1[n]),
	.voice2(voice_2[n]),
	.voice3(voice_3[n]),
	.ext_in({(n ? ext_in_r[17] : ext_in_l[17]), (n ? ext_in_r[17:0] : ext_in_l[17:0]), 3'b000}),  // sign-extend {18b,3b0}->22 bits (Q13.1 compat)
